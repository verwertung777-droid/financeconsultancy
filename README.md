...
- **`<head>`** — meta/SEO tags (title, description, robots, canonical), Open Graph, Twitter Card, JSON-LD structured data (WebSite + WebPage + FinancialService + FAQPage), Google Fonts (Inter + Playfair Display), all CSS in one `<style>` block
